...
// Generated on: 2013.04.12 at 11:10:03 AM MESZ 
//
 ...
 * generated in the jaxbObjects package. 
...
public class ObjectFactory {
    ...
    private final static QName _Calories_QNAME = new QName("", "calories");
    private final static QName _Severity_QNAME = new QName("", "severity");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxbObjects
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "calories", defaultValue = "keine Angabe")
    public JAXBElement<String> createCalories(String value) {
        return new JAXBElement<String>(_Calories_QNAME, String.class, null, value);
    }
